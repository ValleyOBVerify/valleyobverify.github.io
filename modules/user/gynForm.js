                  ...
                  <div class="col-lg-6">
                    <div class="user-insurance-form-wrapp">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="mdl-input-bx">
                            <label>Annual Preventative Visit:</label>
                            <input
                              type="text"
                              name=""
                              id=""
                              ...
                              autocomplete="off"
                              required=""
                              placeholder="Enter Annual Preventative Visit"
                              spellcheck="false"
                            />
                            <div value="div" class="form-control"></div>
                          </div>
                      ...
                      <div class="mdl-input-bx">
                        ...
                        <input
                          ...
                          autocomplete="off"
                          required=""
                          placeholder="Enter Billing Guidelines:"
                          spellcheck="false"
                        />
                        <div value="div" class="form-control"></div>
                      </div>
...
export { gynFormPage, gynFormLoad };
